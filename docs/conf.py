# -*- coding: utf-8 -*-
#
# IAST documentation build configuration file, created by
...
MOCK_MODULES = ['pandas', 'numpy', 'pandas', 'scipy', 'scipy.interpolate', 'scipy.optimize', 'matplotlib', 'matplotlib.pyplot', 'isotherms', 'IAST']
